...
| 003 | [The test could not see it](cases/003-hls-passes-csim-drops-a-beat/) | HLS, AXI-Stream integration | `AWAITING INDEPENDENT REPRODUCTION` | [rope-hls-vs-rtl](https://github.com/taitashaw/rope-hls-vs-rtl) |
